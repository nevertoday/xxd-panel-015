<p align="center">
  <img src="./assets/banner.svg" alt="XXD Panel 015 project banner" width="1200">
</p>
...
If an unrelated photograph could replace the source without materially changing mass ratios, axes, curves, interlocks, negative shapes, colour areas, or type path, the result is not 015.

## The 015 visual contract
...
| --- | --- | --- |
| `top-bottom` | source-adaptive | complete source above, 015 minimal abstract-memory editorial below; both panels retain the source size and split exactly 50/50 |
| `left-right` | source-adaptive | complete source left, 015 minimal abstract-memory editorial right; both panels retain the source size and split exactly 50/50 |
...
Exact user pixels > explicit ratio or destination > source adaptation for ordinary modes. The original `015.md` used a 3:4 creative canvas, but that historical example is not a silent default in the current Skill.
...
- [Chinese full prompt](references/xxd-panel-015-prompt.zh-CN.md)
- [English full prompt](references/xxd-panel-015-prompt.en.md)
- [Original style brief](references/015-source.md)
