<p align="center">
  <img src="./assets/banner.svg" alt="XXD Panel 015 プロジェクトバナー" width="1200">
</p>
...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090123569984679990"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 015 作例 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090123569984679990"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 015 作例 2"></a></td>
  </tr>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090123569984679990"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 015 作例 3"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090123569984679990"><img src="./assets/examples/sample-04.jpg" alt="XXD Panel 015 作例 4"></a></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 015 作例 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 015 作例 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 015 作例 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 015 作例 8"></td>
  </tr>
</table>

## 追加 3:4 上下構成作例

上の 16:9 作例と同じ4点の独立素材を、完全な 3:4 上下構成として再生成しました。上部は現実の写真を保ち、下部は Panel 015 の原文プロンプトに従って再構成しています。英語コピーは各写真の内容・空気・含意だけから生成し、全点を個別に確認しました。

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 015 追加上下作例 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 015 追加上下作例 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 015 追加上下作例 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 015 追加上下作例 4"></td>
  </tr>
</table>

> 追加サンプル：陳翔ポスターのグループから対応する陳翔ポスターグループの4枚をファイル名順に使用し、この Panel の原文ブリーフに従う16:9左右構成と英語の自動生成テキストで作成しました。

> [小小東（@xiaoxiaodong01）](https://x.com/xiaoxiaodong01/status/2090123569984679990) · 2026-08-19<br>
> GPT2 x 几何图形 x 留白 x 美学提示词 x VOL.015

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2090123569984679990">元の投稿と完全なプロンプトを見る →</a></p>

これらの作例は 015 の美的意図を示すものであり、作例の被写体、構図、配色、コピー、旧キャンバス比率が生成時の参照や現在の既定値になることはありません。

> 分解—選択—凝縮—再構成 · 少数の形 · 厳密な色役割 · 象牙色の余白 · アートブックの小文字

XXD Panel 015 は、Codex と互換 Agent のための画像生成 Skill です。写真を分解、選択、凝縮、再構成し、最も固有な量感比、軸、曲線、交差、重層、遮蔽、負の空間、尺度差、非対称だけを少数の幾何形へ残し、一目で元写真に対応する抽象記憶を作ります。
...
**Panel 015** は、原写真の核を保ちながら、次の視覚方向を目指す制作に向いています：**写真を、極簡の抽象記憶と完全な編集システムへ**。まず用途と期待する結果を確認し、そこから構図、サイズ、文字、納品形式を決めます。
...
> XXD Panel 015 でこの画像を処理して、まず最適な構図とサイズを提案して。
...
無関係な写真に替えても量感比、軸、曲線、交差、負形、色面積、文字経路がほぼ成立するなら、それは 015 ではありません。
...
画像フォルダーを直接渡すと、この兵士 Skill が同じ Panel 015 の原文美学で一括処理します。一般的なラスター形式を既定で再帰検索し、件数を報告してから、モード・サイズ・文字・言語を一度だけ確認します。各画像は内容や文言を混ぜず独立生成し、バッチ全体は一つのフラットなタスクフォルダーへ保存します。個別の失敗は記録し、後続画像を黙って省略しません。
...
/xxd-panel-015 photo.jpg --mode top-bottom --size auto --text prompt --locale ja-JP
...
/xxd-panel-015 photo.jpg --mode design-only --size 3:4 --text prompt --locale ja-JP

# 正確な文言を、書き換え・翻訳・タイトル追加なしで使用
/xxd-panel-015 photo.jpg --mode design-only --size 3:4 --copy "光をここに残す" --locale ja-JP

# 2モード × 3サイズで独立した完成構図を6枚生成
/xxd-panel-015 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ja-JP

# フォルダー全体へ Panel 015 を適用し、共通設定は一度だけ解決
/xxd-panel-015 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ja-JP
...
Claude Code では同じフォルダを `~/.claude/skills/xxd-panel-015` にリンクできます。インストール後に Agent セッションを再起動してください。
...
- [中国語ランタイムアダプター](references/xxd-panel-015-prompt.zh-CN.md)
- [英語ランタイムアダプター](references/xxd-panel-015-prompt.en.md)
